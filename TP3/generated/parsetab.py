...
_lr_productions = [
  ...
  ('statement -> expression','statement',1,'p_statement','parser4.py',15),
  ('statement -> structure','statement',1,'p_statement','parser4.py',16),
  ('statement -> PRINT expression','statement',2,'p_statement_print','parser4.py',20),
  ('structure -> WHILE expression { programme }','structure',5,'p_structure','parser4.py',24),
  ('assignation -> IDENTIFIER = expression','assignation',3,'p_assign','parser4.py',28),
  ('expression -> IDENTIFIER','expression',1,'p_expression_var','parser4.py',32),
  ('expression -> NUMBER','expression',1,'p_expression','parser4.py',36),
  ('expression -> ADD_OP expression','expression',2,'p_minus','parser4.py',46),
  ('expression -> ( expression )','expression',3,'p_expression_paren','parser4.py',50),
  ('expression -> expression ADD_OP expression','expression',3,'p_expression_op','parser4.py',54),
  ('expression -> expression MUL_OP expression','expression',3,'p_expression_op','parser4.py',55),
]
